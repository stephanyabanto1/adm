...
int main(){
	...
	while(1)
	{
		...
		// Acceleration_angle[2] = atan((Acc_rawZ/16384.0)/sqrt(pow((Acc_rawX/16384.0),2) + pow((Acc_rawZ/16384.0),2)))*rad_to_deg;
		...
		Total_angle[2] = Gyro_angle[2] + Gyro_angle[2] * elapsedTime;
