...
int main(){
	...
	while(1)
	{
		...
		// Acceleration_angle[2] = atan((Acc_rawZ/16384.0)/sqrt(pow((Acc_rawX/16384.0),2) + pow((Acc_rawY/16384.0),2)))*rad_to_deg;
		...
		printf("\r%f,%f,%f", Total_angle[0], Total_angle[1], Total_angle[2]);
		fflush(stdout);
	}
	return 0;
}